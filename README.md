...
A large stock market dataset is publicly available on Kaggle (https://www.kaggle.com/datasets/borismarjanovic/price-volume-data-for-all-us-stocks-etfs) which contains daily price and volume data for all US-based stocks and ETFs trading on NYSE, NASDAQ, and NYSE MKT.
